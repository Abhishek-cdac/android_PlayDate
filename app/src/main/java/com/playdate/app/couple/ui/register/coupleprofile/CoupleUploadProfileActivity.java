package com.playdate.app.couple.ui.register.coupleprofile;
...
public class CoupleUploadProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //    uploadImage();
            ...
            startActivity(new Intent(CoupleUploadProfileActivity.this, InterestActivity
                    .class));
        });
        ...
        call.enqueue(new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                if (response.code() == 200) {
                    ...
                    new CommonClass().showDialogMsg(CoupleUploadProfileActivity.this, "PlayDate", "An error occurred!", "Ok");
