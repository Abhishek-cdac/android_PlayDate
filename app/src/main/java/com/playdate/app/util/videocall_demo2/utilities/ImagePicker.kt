...
fun cropImage(activity: AppCompatActivity, path: String) {
    ...
    options.setToolbarColor(activity.resources.getColor(R.color.color_pink))
    options.setStatusBarColor(activity.resources.getColor(R.color.blue_violet))
    ...
    options.setActiveWidgetColor(activity.resources.getColor(R.color.color_pink))
