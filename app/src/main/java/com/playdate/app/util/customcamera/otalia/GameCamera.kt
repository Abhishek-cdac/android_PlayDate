...
class GameCamera : AppCompatActivity(), View.OnClickListener, OptionView.Callback {
...
//
        var filterAdapter = GameCameraAdapter(allFilters)
...
//                Option.OverlayInVideoSnapshot(watermark),
    ...
    private fun setFactory() {
        textSwitcher.setFactory(ViewSwitcher.ViewFactory {
            val myText = TextView(this@GameCamera)
...
//            R.id.capturePictureSnapshot -> capturePicture()
//            R.id.captureVideo -> capturePicture()
            R.id.captureVideoSnapshot -> capturePicture()
